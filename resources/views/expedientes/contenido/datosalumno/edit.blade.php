...
<header class="section-header">
    ...
    <section class="card">
        <div class="card-block">
            <div class="row">
                <form action="{{route('datos.update', [$ciclo, $nivel, $grupo, $alumno, $dato])}}" method="post">
                    @csrf
                    @method('put')

                    <fieldset class="form-group col-12 col-md-3 col-lg-3">
                        <label class="form-label">Fecha de nacimiento:</label>
                        <div class='input-group date'>
                            <input id="daterange3" name="fecha_nacimiento" type="text" value="{{$dato->fecha_nacimiento}}" class="form-control"
                    ...
                    <fieldset class="form-group col-12 col-md-3 col-lg-3">
                        ...
                        <input style="text-transform:uppercase;" name="curp" type="text"
                            ...
                            data-validation-message="Debes agregar una CURP" value="{{$dato->curp}}">
                    </fieldset>
                    ...
                    <fieldset class="form-group col-12 col-md-3 col-lg-3">
                        ...
                        <select name="tipo_sangre" id="select" class="form-control"
                            ...
                            <option value="{{$dato->tipo_sangre}}">{{$dato->tipo_sangre}}</option>
                    ...
                    <fieldset class="form-group col-12 col-md-12 col-lg-12">
                        ...
                        <textarea name="situacion_familiar" rows="4" class="form-control">{{$dato->situacion_familiar}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Relaciones familiares</label>
                        <textarea name="relacion_familiar" rows="4" class="form-control">{{$dato->relacion_familiar}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Personalidad del alumno</label>
                        <textarea name="personalidad" rows="4" class="form-control">{{$dato->personalidad}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Descripción breve de como es el alumno</label>
                        <textarea name="descripcion" rows="4" class="form-control">{{$dato->descripcion}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Enfermedades o padecimientos:</label>
                        <textarea name="enfermedades" rows="4" class="form-control">{{$dato->enfermedades}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Alergias:</label>
                        <textarea name="alergias" rows="4" class="form-control">{{$dato->alergias}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Deficiencias o dificultades:</label>
                        <textarea name="deficiencias" rows="4" class="form-control">{{$dato->deficiencias}}</textarea>
                    </fieldset>

                    <fieldset class="form-group col-12 col-md-6 col-lg-6">
                        <label class="form-label">Atenciones especiales:</label>
                        <textarea name="atencion" rows="4" class="form-control">{{$dato->atencion}}</textarea>
                    </fieldset>
                    ...
                    <div class="form-group form-group-radios col-12 col-md-3 col-lg-3">
                        ...
                        <div class="radio">
                            <input id="signup_v2-faltas-no" name="faltas"
                                data-validation-group="signup_v2-faltas" type="radio" value="0" checked>
                            <label for="signup_v2-faltas-no">No</label>
                        </div>
                        @endif
                    </div>
